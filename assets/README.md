...
2. **Naming Convention:** Use clear, lowercase, kebab-case naming structures (e.g., `malware-execution-flow.png`, `active-directory-map.jpg`).
3. **Data Sanitization:** Ensure no sensitive information (such as external public IPs, plaintext API keys, or personal credentials) is visible in the captured media.

---
> 🔒 **Git Enforcement:** Media files in this directory are strictly monitored via `.gitignore` exceptions to ensure only validated documentation assets are tracked.
